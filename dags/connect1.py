...
class Connect:
    ...
    def __init__(self):
        ...
        #self.host = f'https://{os.environ.get("ERP_HOST")}/api'
    ...
    def login(self):
        ...
        response = auth_session.post(
            ...
            #data={"usr": os.environ.get("ERP_USER"), "pwd": os.environ.get("ERP_PASS")},
...
class API:
    ...
    #     """
    #     Generic POST method to handle API requests.
 
    #     :param endpoint: API endpoint to hit (relative to `self.host`).
    #     :param data: The data payload for the POST request (dict or JSON string).
